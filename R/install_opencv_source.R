install_opencv_source <- function(batch = TRUE, conda_environment = "faceplyr") {
  ...
  if (!ROpenCVLite::isCmakeInstalled())
    install <- 0
  ...
  if(ROpenCVLite::isOpenCVInstalled()) {
    ...
    message("success! OpenCV Installed.")
  }
